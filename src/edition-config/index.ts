...
/** Community defaults. Commercial overlays must not rewrite this module in-tree. */
 ...
 * pptx code unless a proprietary `PptxEditionExtension` is registered —
 * flipping these flags alone never opens those write paths.
 */
